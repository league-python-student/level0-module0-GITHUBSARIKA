...
if __name__ == '__main__':
    ...
    adjective=simpledialog.askstring("Madlibs", "Enter an adjective.")
    # Get the player to enter a type of liquid
    liquid=simpledialog.askstring("Madlibs", "Enter a liquid.")
    # Get the player to enter a body part
    bodyPart=simpledialog.askstring("Madlibs", "Enter a body part.")
    # Get the player to enter a verb
    verb=simpledialog.askstring("Madlibs", "Enter a verb.")
    # Get the player to enter a place
    place=simpledialog.askstring("Madlibs", "Enter a place.")
    ...
    messagebox.showinfo("Final Story!!!", story)
